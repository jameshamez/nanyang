  ...
  return (
    ...
    >
      ...
      <div className="space-y-4 sm:space-y-6 px-4 sm:px-6 md:px-8 lg:px-10 absolute transform -translate-y-[40%] sm:-translate-y-[40%] md:-translate-y-[35%] w-full">
        {[
          {
            img: "/image/3optionA.png",
            imgSelected: "/image/3optionA_selected.png",
            answer: "A",
          },
          {
            img: "/image/3optionB.png",
            imgSelected: "/image/3optionB_selected.png",
            answer: "B",
          },
          {
            img: "/image/3optionC.png",
            imgSelected: "/image/3optionC_selected.png",
            answer: "C",
          },
        ].map((button, index) => (
          <motion.img
