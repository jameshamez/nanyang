...
export default function QuizPage() {
    ...
    return (
        ...
        >
            ...
            >
                {[
                    { img: isEnglish ? "/image/2optionA_en.png" : "/image/2optionA.png",  imgSelected: isEnglish ? "/image/2optionA_selected_en.png" : "/image/2optionA_selected.png", answer: "A" },
                    { img: isEnglish ? "/image/2optionB_en.png" : "/image/2optionB.png",  imgSelected: isEnglish ? "/image/2optionB_selected_en.png" : "/image/2optionB_selected.png", answer: "B" },
                    { img: isEnglish ? "/image/2optionC_en.png" : "/image/2optionC.png",  imgSelected: isEnglish ? "/image/2optionC_selected_en.png" : "/image/2optionC_selected.png", answer: "C" }
                ].map((button, index) => (
                    <motion.img
                        key={index}
