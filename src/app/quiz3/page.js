...
export default function QuizPage() {
  ...
  const handleNextClick = (selectedButton) => {
    if (selectedButton !== null) {
      ...
      router.push("/quiz4"); // Navigate after a short delay
    } else {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 w-[90%]">
        <img src="image/bar3.png" alt="Progress Bar" className="w-full" />
      </div>
      <div
      ...
      <div className={isEnglish ? "space-y-4 sm:space-y-6 px-4 sm:px-6 md:px-8 lg:px-10 absolute transform -translate-y-[40%] sm:-translate-y-[40%] md:-translate-y-[30%] lg:-translate-y-[30%] w-full" : "space-y-4 sm:space-y-6 px-4 sm:px-6 md:px-8 lg:px-10 absolute transform -translate-y-[40%] sm:-translate-y-[40%] md:-translate-y-[30%] lg:-translate-y-[30%] w-full"}>
        {[
          {
            img: isEnglish ? "/image/3optionA_en.png" : "/image/3optionA.png",
            imgSelected: isEnglish
              ? "/image/3optionA_selected_en.png"
              : "/image/3optionA_selected.png",
            answer: "A",
          },
          {
            img: isEnglish ? "/image/3optionB_en.png" : "/image/3optionB.png",
            imgSelected: isEnglish
              ? "/image/3optionB_selected_en.png"
              : "/image/3optionB_selected.png",
            answer: "B",
          },
          {
            img: isEnglish ? "/image/3optionC_en.png" : "/image/3optionC.png",
            imgSelected: isEnglish
              ? "/image/3optionC_selected_en.png"
              : "/image/3optionC_selected.png",
            answer: "C",
          },
        ].map((button, index) => (
          <motion.img
      ...
      >
        <div className="w-[150px] sm:w-[180px] md:w-[200px] lg:w-[250px] bottom-[-120px] sm:bottom-[-120px] md:bottom-[-76px] lg:bottom-[-100px] left-[-60px] md:left-[-80px] lg:left-[-96px] absolute">
          <img
            src="image/tree3.png"
